    ...
    <div class="col-md-2" id="actions-sidebar">
        <div class="box box-primary">
            ...
            <ul class="nav nav-pills nav-stacked">
                <li><?= $this->Html->link(__('Nova Categoria', ['Category']), ['action' => 'add']) ?></li>
            </ul>
        </div>
    </div>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="paginator text-center">
                    ...
                    <p><?= $this->Paginator->counter(__('Pagina {{page}} de {{pages}}, listando {{current}} registro(s) de {{count}} total')) ?></p>
                </div>
            </div>
        </div>
    </div>
